 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Hi;Hi="",Ri(new Gr("platform-logger",(e=>new Ei(e)),"PRIVATE")),Ri(new Gr("heartbeat",(e=>new Bi(e)),"PRIVATE")),Li("@firebase/app","0.8.4",Hi),Li("@firebase/app","0.8.4","esm2017"),Li("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
class xo extends so{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?ls(e.name,t.name):i}makePost(e,t){const n=Ao(e),r=Oo.EMPTY_NODE.updateChild(this.indexPath_,n);return new io(t,r)}maxPost(){const e=Oo.EMPTY_NODE.updateChild(this.indexPath_,Po);return new io("[MAX_NAME]",e)}toString(){return Vs(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,tr(!Js(e)&&".priority"!==Ws(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=library.df26c22d.js.map
