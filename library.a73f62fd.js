 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;_s(e,((e,r)=>{r>0&&Lr(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),Es(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Qo(e);const n=1e4+2e4*Math.random();Es(this.reportStats_.bind(this),Math.floor(n))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pu(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(yu(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(gu(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(wu(t))return"Blackberry";if(bu(t))return"Webos";if(mu(t))return"Safari";if((t.includes("chrome/")||_u(t))&&!t.includes("edge/"))return"Chrome";if(vu(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function gu(e=fr()){return/firefox\//i.test(e)}function mu(e=fr()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function _u(e=fr()){return/crios\//i.test(e)}function yu(e=fr()){return/iemobile/i.test(e)}function vu(e=fr()){return/android/i.test(e)}function wu(e=fr()){return/blackberry/i.test(e)}function bu(e=fr()){return/webos/i.test(e)}function Eu(e=fr()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Iu(){return _r()&&10===document.documentMode}function Cu(e=fr()){return Eu(e)||vu(e)||bu(e)||wu(e)||/windows phone/i.test(e)||yu(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Eh(e,t){return t?Ul(t):(xl(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */bh.PROVIDER_ID="phone",bh.PHONE_SIGN_IN_METHOD="phone";class Ih extends xu{_getIdTokenResponse(e){return Mu(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Mu(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Mu(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Ch(e){return eh(e.auth,new Ih(e),e.bypassAuthState)}function Th(e){const{auth:t,user:n}=e;return xl(n,t,"internal-error"),Zu(n,new Ih(e),e.bypassAuthState)}async function Sh(e){const{auth:t,user:n}=e;return xl(n,t,"internal-error"),Xu(n,new Ih(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const rd=Ir("authIdTokenMaxAge")||300;let id=null;var sd;sd="Browser",Pi(new Qr("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:s}=n.options;return((e,n)=>{xl(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),xl(!(null==s?void 0:s.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:s,clientPlatform:sd,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Tu(sd)},o=new ku(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Ul);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(o,t),o})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Pi(new Qr("auth-internal",(e=>{const t=Ru(e.getProvider("auth").getImmediate());return new nd(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ui("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(sd)),Ui("@firebase/auth","0.20.11","esm2017");const od=function(e=Mi(),t){const n=Ai(e,"database").getImmediate({identifier:t}),r=Er("database");return r&&function(e,t,n,r={}){(e=Yr(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&ls("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&ls('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new Ts(Ts.OWNER);else if(r.mockUserToken){const t="string"==typeof r.mockUserToken?r.mockUserToken:Tr(r.mockUserToken,e.app.options.projectId);s=new Ts(t)}!function(e,t,n,r){e.repoInfo_=new ks(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams),r&&(e.authTokenProvider_=r)}(i,t,n,s)}(n,...r),n}(Di({apiKey:"AIzaSyAfAXK_eMmM8x3Fv1Qp4fXOpLOfKmbbEck",authDomain:"movieproject11.firebaseapp.com",databaseURL:"https://movieproject11-default-rtdb.europe-west1.firebasedatabase.app",projectId:"movieproject11",storageBucket:"movieproject11.appspot.com",messagingSenderId:"414406009031",appId:"1:414406009031:web:e07613adfc75fe7967dee2",measurementId:"G-HM44PYJGKZ"}));!function(e=Mi()){const t=Ai(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Ai(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Fr(n.getOptions(),null!=t?t:{}))return e;Nl(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:td,persistence:[_h,rh,sh]}),r=Ir("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>rd)return;const r=null==t?void 0:t.token;id!==r&&(id=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){Yr(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){Yr(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const s=br("auth");s&&Ou(n,`http://${s}`)}();function ad(e){Mn.addEventListener("click",(function(e){Ln.removeEventListener("click",r),Dn.removeEventListener("click",r)})),window.addEventListener("keydown",(function(e){"Escape"===e.code&&(Ln.removeEventListener("click",r),Dn.removeEventListener("click",r))})),Ln.addEventListener("click",r),Dn.addEventListener("click",r);let t=e,n=(e.id,"");function r(r){let i=!1,s=!1;var o;"ADD TO WATCHED"===r.currentTarget.innerText?(n="watched_movies",i=!0):"ADD TO QUEUE"===r.currentTarget.innerText?(n="queue_movies",i=!0):"REMOVE FROM VIEWS"===r.currentTarget.innerText?(n="watched_movies",s=!0):"REMOVE FROM QUEUE"===r.currentTarget.innerText&&(n="queue_movies",s=!0),!0===i&&yl(ml(od,n+"/"+t.title),e).then((()=>{console.log("ok")})).catch((e=>{console.log(e)})),!0===s&&(o=ml(od,n+"/"+t.title),Fc("remove",o._path),yl(o,null)).then((()=>{console.log("remove ok")})).catch((e=>{console.log(e)}))}}const cd=new Fn;function ld(e){let t=cd.findGenresById(e);null!==e.poster_path&&(Sn.src=`https://www.themoviedb.org/t/p/original/${e.poster_path}`),Sn.alt=`${e.original_title}`,kn.textContent=`${e.title}`,Rn.textContent=`${e.vote_average}`,Nn.textContent=`${e.vote_count}`,On.textContent=`${e.popularity}`,Pn.textContent=`${e.original_title}`,An.textContent=`${t}`,xn.textContent=`${e.overview}`,ad(e),Bn(e)}async function ud(e){try{const t=await cd.fetchMovies(e);0===t.data.total_results?(Cn.textContent="Sorry, there are no movies matching your search query. Please try again.",setTimeout((()=>Cn.textContent=""),3e3)):Tn.innerHTML=function(e){let t="";return e.data.results.map((e=>{let n=cd.findGenresById(e);t+=`<li class="movie__card">\n    <a href="https://www.themoviedb.org/t/p/original/${e.backdrop_path}"><img class="movie__poster" src="https://www.themoviedb.org/t/p/original/${e.poster_path}" alt="${e.original_title}" loading="lazy" id="${e.id}"></a>\n    <div class="movie__info">\n    <h2 class="movie__name">${e.title}</h2>\n    <p class="movie__info">${n}<span class="movie__year">${e.release_date.slice(0,4)}</span></p>\n    </div>\n    </li>`})),t}(t)}catch(e){Cn.textContent="Please write something in the box :)",setTimeout((()=>Cn.textContent=""),3e3),console.log(e)}}bn.addEventListener("submit",(function(e){e.preventDefault(),cd.query=bn.elements.searchmovies.value,ud(`https://api.themoviedb.org/3/search/movie?api_key=c491b5b8e2b4a9ab13619b0a91f8bb41&language=en-US&page=${cd.page}&include_adult=false&query=${cd.query}`)}));cd.getGenre(),ud("https://api.themoviedb.org/3/trending/movie/day?api_key=c491b5b8e2b4a9ab13619b0a91f8bb41");const hd=new Fn;let dd="https://api.themoviedb.org/3/trending/movie/day?api_key=c491b5b8e2b4a9ab13619b0a91f8bb41";function fd(e){"Escape"===e.code&&(document.body.classList.toggle("is-open"),In.classList.toggle("is-hidden"),window.removeEventListener("keydown",fd))}function pd(e){document.body.classList.toggle("is-open"),In.classList.toggle("is-hidden"),window.removeEventListener("keydown",pd)}Tn.addEventListener("click",(async function(e){if(e.preventDefault(),"IMG"!==e.target.nodeName&&"H2"!==e.target.nodeName)return;dd=function(e){""!==document.querySelector(".header__form-input").value&&(hd.query=e.target.alt.replace("#",""),dd=`https://api.themoviedb.org/3/search/movie?api_key=c491b5b8e2b4a9ab13619b0a91f8bb41&language=en-US&page=${hd.page}&include_adult=false&query=${hd.query}`);return dd}(e);const t=await hd.fetchMovies(dd);ld(t.data.results.find((t=>t.id===Number(e.target.id)))),document.body.classList.toggle("is-open"),In.classList.toggle("is-hidden"),Mn.addEventListener("click",pd),window.addEventListener("keydown",fd)}));const gd=document.getElementById("teamModal"),md=document.getElementById("myBtn"),_d=document.getElementsByClassName("close")[0];md.onclick=function(){gd.style.display="block"},void 0!==_d&&(_d.onclick=function(){gd.style.display="none"}),window.onclick=function(e){e.target==gd&&(gd.style.display="none")};var yd,vd={};
/*!
 * TOAST UI Pagination
 * @version 3.4.1
...
//# sourceMappingURL=library.a73f62fd.js.map
